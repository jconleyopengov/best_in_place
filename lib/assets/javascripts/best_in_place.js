...
BestInPlaceEditor.prototype = {
  // Public Interface Functions //////////////////////////////////////////////
    ...
    activate : function () {
        ...
        if (this.toggle_activator) jQuery(this.activator).hide();
        this.activateForm();
  ...
  abort : function() {
    ...
    if (this.toggle_activator) jQuery(this.activator).show();
    jQuery(this.activator).bind('click', {editor: this}, this.clickHandler);
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.toggle_activator  = self.toggle_activator  || $parent.attr("data-toggle-activator");
    ...
    self.toggle_activator  = self.element.attr("data-toggle-activator")    || self.toggle_activator || false;
